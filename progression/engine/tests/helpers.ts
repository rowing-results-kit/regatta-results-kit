import allJapanA from "../../templates/alljapan-a.json";
import allJapanB from "../../templates/alljapan-b.json";
import {
...
export function loadTemplate(id: string): ProgressionTemplate {
  if (id === "alljapan-2026-A" || id === "alljapan-a") {
    return allJapanA as ProgressionTemplate;
  }
  if (id === "alljapan-2026-B" || id === "alljapan-b") {
