...
| Step 2 | Cloudflare ダッシュボード ログイン画面 | `cf-login.png` | 自動撮影可（Turnstile表示） | 取得済 | 2026-06-13 | https://dash.cloudflare.com/login |
...
| `cf-login.png` | https://dash.cloudflare.com/login |
